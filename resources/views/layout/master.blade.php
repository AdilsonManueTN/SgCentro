...
<!-- PAGE PLUGINS -->
<!-- jQuery Mapael -->
<script src="{{ asset('master/plugins/jquery-mousewheel/jquery.mousewheel.js') }}"></script>
<script src="{{ asset('master/plugins/raphael/raphael.min.js') }}"></script>
<script src="{{ asset('master/plugins/jquery-mapael/jquery.mapael.min.js') }}"></script>
<script src="{{ asset('master/plugins/jquery-mapael/maps/usa_states.min.js') }}"></script>
<!-- ChartJS -->
